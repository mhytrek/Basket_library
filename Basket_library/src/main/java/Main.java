...
public class Main {
    public static void main(String[] args) {
        BasketSplitter basketSplitter = new BasketSplitter("/Users/michalinahytrek/Documents/Programowanie/OCADO/Ocado_basket_library/Basket_library/src/main/configuration/config.json");
